...
//	@Before(value = "")
//	public void setUp() {
//		vendorService = spy(vendorServiceImpl);
//	}
...
//		assertEquals(vendor.getEmail(), createdVendor.getEmail());
	...
	public void testGetVendorById() {
		...
		assertSame(vendor, retrievedVendor);
...
//		Vendor retrievedVendor =  vendorService.getVendorById(2L);
//		
//		assertSame(null, retrievedVendor);
		...
		assertEquals("Vendor not found with this id", exception.getMessage());
	...
	@Test
	public void testGetByVendorCodeNotFound() {
//		when(vendorRepository.findById(2L)).thenReturn(Optional.empty());
//		Vendor retrievedVendor =  vendorService.getVendorById(2L);
//		
//		assertSame(null, retrievedVendor);
		
		String invalidVendorCode = "123";
		ResourceNotFoundException exception = assertThrows(ResourceNotFoundException.class, () -> {
			vendorService.getVendorByVendorCode(invalidVendorCode);
		});
		
		assertEquals("Vendor not found with this vendorCode", exception.getMessage());
